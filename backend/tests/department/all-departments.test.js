...
/**
 * Testing Get all-departments Route
 */
describe('Testing get all-departments Endpoint', () => {
 ...
 // For CheckAuth Purpose
  ...
  test('it should fetch a list containing all departments', async () => {
    const result = await request(app)
      .get(`/api/department/all-departments`)
      .set('Authorization', 'Bearer ' + token)
      .expect(200);

    expect(result.body.departments).toMatchObject([dbSetup.departmentOne]);
  });
