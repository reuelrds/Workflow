...
@Component({
  selector: 'app-location-data-table',
  templateUrl: './location-data-table.component.html',
  styleUrls: ['./location-data-table.component.scss']
})
export class LocationDataTableComponent implements OnInit, OnChanges {
   ...
   */
  @Input() data: Observable<Location[]>;
